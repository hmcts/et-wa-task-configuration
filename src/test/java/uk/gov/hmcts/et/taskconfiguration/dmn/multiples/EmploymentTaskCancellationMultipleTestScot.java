...
import static uk.gov.hmcts.et.taskconfiguration.DmnDecisionTable.WA_TASK_CANCELLATION_MULTIPLE_ET_SCOTLAND;

class EmploymentTaskCancellationMultipleTestScot extends DmnDecisionTableBaseUnitTest {

    @BeforeAll
    public static void initialization() {
        CURRENT_DMN_DECISION_TABLE = WA_TASK_CANCELLATION_MULTIPLE_ET_SCOTLAND;
    }
