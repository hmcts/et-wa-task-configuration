            ...
            Arguments.of(
                ...
                List.of(
                    HelperService.mapExpectedOutput(
                        ...
                        "Review Referral response - Judge",
                        "Processing, referralNumber_2"
                    )
                )
            ),
            Arguments.of(
                ...
                List.of(
                    HelperService.mapExpectedOutput(
                        ...
                        "Review Referral response - Legal Officer",
                        "Processing, referralNumber_2"
                    )
                )
            ),
