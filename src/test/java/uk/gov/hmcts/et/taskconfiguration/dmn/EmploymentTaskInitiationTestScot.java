...
class EmploymentTaskInitiationTestScot extends DmnDecisionTableBaseUnitTest {
        ...
        return Stream.of("SUBMIT_CASE_DRAFT", "UPDATE_CASE_SUBMITTED", "SUBMIT_ET3_FORM", "UPDATE_ET3_FORM",
            ...
            .flatMap(eventId -> Stream.of(
                Arguments.of(eventId, "adminTaskRequired",
                    "ReviewSupportRequestAdmin", "Admin - Review Support Request", "ReviewSupportAdmin"),
                Arguments.of(eventId, "legalOfficerTaskRequired",
                    "ReviewSupportRequestLegalOfficer", "LO - Review Support Request",
                    "ReviewSupportLegalOfficer"),
                Arguments.of(eventId, "judgeTaskRequired",
                    "ReviewSupportRequestJudge", "EJ - Review Support Request", "ReviewSupportJudge")
            ));
    }
    ...
    void required_indicator_creates_the_matching_review_task(String eventId,
        ...
        inputVariables.putAll(taskRequiredData(requiredField, true));
        ...
        expected.add(HelperService.mapExpectedOutput(taskId, taskName, processCategory));
    ...
    void active_flag_creates_arrange_support_task(String eventId) {
        ...
        expected.add(arrangeSupportTask());
        assertThat(evaluateDmnTable(inputVariables).getResultList(), is(expected.build().toList()));
    }

    static Stream<String> arrangeSupportEventProvider() {
        return Stream.of("SUBMIT_CASE_DRAFT", "UPDATE_CASE_SUBMITTED", "SUBMIT_ET3_FORM", "UPDATE_ET3_FORM",
            "requestSupport", "createFlag", "manageFlags", "reviewAdminSupportRequest",
            "reviewLOSupportRequest", "reviewJudgeSupportRequest", "createArrangeSupportTask");
    }
    ...
    private static Map<String, Object> taskRequiredData(String field, Object value) {
        return Map.of(
            "additionalData", Map.of(
                "Data", Map.of(
